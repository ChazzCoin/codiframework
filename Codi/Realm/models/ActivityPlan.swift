...
@objcMembers class ActivityPlan: Object, Identifiable {
    ...
    dynamic var dateCreated: String = TimeProvider().generateTimestamp()
    dynamic var dateUpdated: String = TimeProvider().generateTimestamp()
    dynamic var dateOf: String = TimeProvider().generateTimestamp()
